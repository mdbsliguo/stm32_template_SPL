...
**命名规范**：案例文件夹命名格式为 `分类名序号_功能描述`，序号从01开始按顺序递增。
...
├── i2c/                    # I2C通信相关案例
│   ├── i2c01_ds3231_i2c_hw/    # DS3231硬件I2C示例
│   └── i2c02_ds3231_i2c_sw/    # DS3231软件I2C示例
├── error_handler/          # 错误处理相关案例
│   └── error_handler01_xxx/    # 错误处理模块测试
├── system/                 # 系统服务相关案例
│   └── system01_clock_manager/ # 时钟管理示例
├── can/                    # CAN总线相关案例（待添加）
├── ds3231/                 # DS3231相关案例（待添加）
├── iwdg/                   # 独立看门狗相关案例（待添加）
├── log/                    # 日志相关案例（待添加）
├── module_ctrl/            # 模块控制相关案例（待添加）
├── spi/                    # SPI通信相关案例（待添加）
├── timer/                  # 定时器相关案例（待添加）
├── uart/                   # 串口通信相关案例（待添加）
└── README.md               # 本文档
