/**
 * @file config.h
 * @brief Bus03案例专用配置（独立工程）
 * @details 只启用Bus03案例需要的模块，禁用其他模块以减小代码体积
 */
...
/* 驱动层模块 */
#define CONFIG_MODULE_GPIO_ENABLED          1   /**< GPIO模块开关 - 必须（UART、编码器依赖） */
...
#define CONFIG_MODULE_TIMER_ENABLED         1   /**< 定时器模块开关 - 启用（编码器需要） */
...
#define CONFIG_MODULE_NVIC_ENABLED         1   /**< NVIC模块开关 - 启用（编码器中断需要） */
