/**
 * @file board.h
 * @brief 硬件配置头文件（Timer02_InternalClockCounting案例独立工程专用）
...
/* UART统一配置表 - Timer02案例配置（USART1，PA9/PA10，115200，8N1） */
#define UART_CONFIGS {                                                                                    \
...
/* 时钟管理配置 - 默认配置（Timer02不使用，但需要定义以避免编译错误） */
...
#define CLKM_ADAPTIVE_ENABLE 0         /* 禁用自动调频（Timer02不使用） */
