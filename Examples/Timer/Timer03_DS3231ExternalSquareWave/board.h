/**
 * @file board.h
 * @brief 硬件配置头文件（Timer03_DS3231ExternalSquareWave案例独立工程专用）
...
/* UART统一配置表 - Timer03案例配置（USART1，PA9/PA10，115200，8N1） */
#define UART_CONFIGS {                                                                                    \
...
/* TIM1 ETR引脚配置 - Timer03案例配置 */
/* 注意：TIM1的ETR引脚是PA12，用于接收DS3231的SQW输出（1Hz方波） */
...
/* 时钟管理配置 - 默认配置（Timer03不使用，但需要定义以避免编译错误） */
...
#define CLKM_ADAPTIVE_ENABLE 0         /* 禁用自动调频（Timer03不使用） */
