/**
 * @file main_example.c
 * @brief 案例11 - DS3231实时时钟模块演示（硬件I2C接口）
...
int main(void)
{
    ...
    OLED_Clear();
    OLED_ShowString(1, 1, "Example 11");
    OLED_ShowString(2, 1, "DS3231 Demo");
    OLED_ShowString(3, 1, "I2C2 PB10/11");
    Delay_ms(1500);
    ...
    if (i2c_status != I2C_OK)
    {
        ...
        /* 显示错误码 */
        char err_buf[17];
        snprintf(err_buf, sizeof(err_buf), "Error: %d", i2c_status);
    ...
    /* Initialize DS3231 (hardware I2C interface) */
