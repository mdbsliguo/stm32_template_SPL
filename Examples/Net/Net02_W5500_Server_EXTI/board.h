/**
 * @file board.h
 * @brief Net02 ??? F103ZE + W5500 ?????EXTI ???
 *
 * W5500?PB3 SCK / PB4 MISO / PB5 MOSI?SPI1 ????
 *        PF11 SCSn?PF9 INTn?EXTI9 ?????RST ??????
 * ???USART1 PA9/PA10?LED PC4
 */
...
#define LED_CONFIGS {                                                      \
    {GPIOC, GPIO_Pin_4, Bit_RESET, 1}, /* PC4 ????????? */         \
}
...
#ifndef W5500_EXTI_LINE
#define W5500_EXTI_LINE  EXTI_LINE_9
#endif

#define EXTI_CONFIGS {                                                                                  \
    {EXTI_LINE_0, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_1, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_2, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_3, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_4, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_5, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_6, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_7, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_8, NULL, 0, EXTI_TRIGGER_FALLING, EXTI_MODE_INTERRUPT, 0},                             \
    {EXTI_LINE_9, GPIOF, GPIO_Pin_9, EXTI_TRIGGER_RISING_FALLING, EXTI_MODE_INTERRUPT, 1},                   \
}
