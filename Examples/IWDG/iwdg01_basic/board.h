/**
 * @file board.h
 * @brief 硬件配置头文件（iwdg01_basic独立工程专用）
 * @details 此文件包含iwdg01_basic案例所需的硬件配置
 */
...
/* 时钟管理配置 - 默认配置（iwdg01_basic不使用，但需要定义以避免编译错误） */
