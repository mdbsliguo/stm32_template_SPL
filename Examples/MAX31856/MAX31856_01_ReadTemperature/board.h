/**
 * @file board.h
 * @brief 硬件配置头文件（MAX31856案例独立工程专用）
 * @details 此文件包含MAX31856案例所需的硬件配置
 * 
...
/* SPI统一配置表 - MAX31856案例配置（SPI2，PB13/14/15，软件NSS） */
...
/* OLED I2C配置 - MAX31856案例配置（软件I2C，PB8/9） */
