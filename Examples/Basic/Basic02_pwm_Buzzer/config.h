/**
 * @file config.h
 * @brief Basic02_pwm_Buzzer案例专用配置（独立工程）
...
/* 驱动层模块 */
#define CONFIG_MODULE_GPIO_ENABLED          1   /**< GPIO模块开关 - 必须（Buzzer依赖） */
#define CONFIG_MODULE_BUZZER_ENABLED       1   /**< Buzzer模块开关 - 必须（案例使用） */
#define CONFIG_MODULE_TIMER_ENABLED        1   /**< 定时器模块开关 - 必须（PWM模式需要） */
#define CONFIG_MODULE_OLED_ENABLED         1   /**< OLED模块开关 - 启用（用于显示提示信息） */
