...
typedef struct
{
    ...
    PWM_Channel_Config_t channels[4];
    uint8_t enabled;
} PWM_Config_t;

#define PWM_CONFIGS {                                                                                    \
    {TIM1, {{GPIOA, GPIO_Pin_0, 0}, {GPIOA, GPIO_Pin_1, 0}, {GPIOA, GPIO_Pin_0, 0}, {GPIOA, GPIO_Pin_1, 0}}, 0}, /* TIM1：未启用（占位） */ \
    {TIM3, {{GPIOA, GPIO_Pin_6, 1}, {GPIOA, GPIO_Pin_7, 0}, {GPIOA, GPIO_Pin_0, 0}, {GPIOA, GPIO_Pin_1, 0}}, 1}, /* TIM3：PA6(CH1蜂鸣器)，启用 */ \
    {TIM4, {{GPIOA, GPIO_Pin_0, 0}, {GPIOA, GPIO_Pin_1, 0}, {GPIOA, GPIO_Pin_0, 0}, {GPIOA, GPIO_Pin_1, 0}}, 0}, /* TIM4：未启用（占位） */ \
}
