/**
 * @file board.h
 * @brief 硬件配置头文件（ClockManager01_AdaptiveFrequency案例独立工程专用）
...
#define UART_CONFIGS {                                                                                    \
    {USART1, GPIOA, GPIO_Pin_9, GPIOA, GPIO_Pin_10, UART_DEFAULT_BAUDRATE, USART_WordLength_8b, USART_StopBits_1, USART_Parity_No, 1}, /* UART1：PA9(TX), PA10(RX)，115200，8N1，启用 */ \
}
