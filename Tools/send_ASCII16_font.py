#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# ASCII16 Font Upload Tool
# Upload ASCII16 font file to STM32 via UART
#
# Usage:
#     python send_ASCII16_font.py [COM port] [font file] [baudrate]
#
# Example:
#     python send_ASCII16_font.py COM4 ASCII16.bin 115200
#
# Dependencies:
...
def send_font_file(port, baudrate, font_file):
    ...
    try:
        ...
        # Send 'A' command for ASCII16 font
        print("Sending 'A' command (ASCII16 font)...")
        ser.write(bytes([CMD_ASCII16]))
        ser.flush()
...
def main():
    ...
    if len(sys.argv) >= 3:
        ...
        print(f"\nTo customize, use: python send_ASCII16_font.py <COM port> <font file> [baudrate]")
        print()
